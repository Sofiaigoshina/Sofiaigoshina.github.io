...
def apply_yolo_object_detection(image_to_process, classes_to_look_for):
    """
    Recognition and determination of the coordinates of objects on the image
    :param image_to_process: original image
    :param classes_to_look_for: list of classes to look for
    ...
    for box_index in chosen_boxes:
        ...
        if classes[class_index].lower() in classes_to_look_for:
            objects_count += 1
...
def start_video_object_detection(video: str, classes_to_look_for):
    """
    ...
    while True:
        try:
            ...
            while video_camera_capture.isOpened():
                ...
                frame = apply_yolo_object_detection(frame, classes_to_look_for)
...
if __name__ == '__main__':
    ...
    start_video_object_detection(video, classes_to_look_for)
